...
class GlobalFlexibleResolutionSetup(VerosSetup):
    ...
    def set_grid(self, vs):
        ...
        veros.tools.get_vinokur_grid_steps(vs.nz, self.max_depth, self.min_depth, refine_towards='lower')
        vs.y_origin = -80.
        vs.x_origin = 90.
    ...
    def set_topography(self, vs):
        ...
        np.where(z_interp < 0., depth_levels, 0)[2:-2, 2:-2]
        ...
        vs.kbot = jax.ops.index_update(vs.kbot, jax.ops.index[marginal],
        0
    ...
    def set_forcing(self, vs):
        ...
        np.sqrt((0.5 * (vs.surface_taux[1:-1, 1:-1] + vs.surface_taux[:-2, 1:-1])) ** 2
